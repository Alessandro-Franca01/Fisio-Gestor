      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm min-h-0">
        ...
        <div className="flex-1 overflow-auto scroll-smooth">
          <div className="min-w-[800px]">
            {/* Days Header - Sticky */}
            <div className="grid grid-cols-8 border-b border-border-light dark:border-border-dark sticky top-0 bg-surface-light dark:bg-surface-dark z-10 shadow-sm">
            ...
            <div className="divide-y divide-border-light dark:divide-border-dark bg-surface-light dark:bg-surface-dark">
              {hours.map((hour) => (
                <div key={hour} className="grid grid-cols-8 min-h-[100px]">
                  {/* Time Label */}
                  <div className="p-2 border-r border-border-light dark:border-border-dark flex items-start justify-center text-xs font-medium text-subtle-light dark:text-subtle-dark bg-background-light/30 dark:bg-background-dark/30">
                    {hour}
                  </div>
                  ...
                  {weekDays.map((day, dayIndex) => {
                    ...
                    return (
                      <div key={`${dayIndex}-${hour}`} className="relative border-r border-border-light dark:border-border-dark last:border-r-0 p-1 group hover:bg-background-light dark:hover:bg-background-dark/30 transition-colors">
                        {appointment ? (
                          <div 
